...
const dailyResearchBatchAugust13: readonly August13ResearchConfig[] = [
  { slug: 'philippines-workforce-schedule-coverage-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Workforce Schedule Coverage Research 2026', cluster: 'Remote Operations', statistic: '4 coverage windows', statLabel: 'coverage windows', sourceName: 'Department of Labor and Employment', sourceUrl: 'https://www.dole.gov.ph/', focus: 'workforce schedule coverage', finding: 'A schedule is a capacity boundary, not proof that a queue will be covered. Labor guidance and time-zone realities make documented working hours, rest expectations, and handoff ownership necessary parts of a support role.', decision: 'Which hours can the support role cover, what happens outside those hours, and who owns an urgent exception?', evidence: 'Philippine labor and workplace guidance plus time-zone planning', angle: 'coverage planning across Philippine Standard Time and a client team in another zone', caseStudy: 'a support inbox that receives customer questions overnight but has only one named daytime reviewer', measure: 'unanswered items at handoff, schedule exceptions, and owner response time' },
  { slug: 'philippines-knowledge-base-ownership-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Knowledge Base Ownership Research 2026', cluster: 'Data Operations', statistic: '6 article signals', statLabel: 'article signals', sourceName: 'Department of Information and Communications Technology', sourceUrl: 'https://dict.gov.ph/', focus: 'knowledge base ownership', finding: 'Reference material only helps when someone can identify its owner, version, and review status. Digital-government guidance supports treating business knowledge as maintained information rather than a static folder of instructions.', decision: 'Who may propose a change, who approves it, and how does a support worker know which version is current?', evidence: 'digital information governance guidance and records-management principles', angle: 'version ownership for customer and internal reference material', caseStudy: 'a returns article that conflicts with the current approved customer policy', measure: 'stale pages found, unresolved contradictions, and time to approve a correction' },
  { slug: 'philippines-customer-feedback-analysis-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Customer Feedback Analysis Research 2026', cluster: 'Customer Support', statistic: '5 feedback themes', statLabel: 'feedback themes', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/archives/consumer-protection/', focus: 'customer feedback analysis', finding: 'Feedback classification is useful only when the source comments remain traceable and the analyst does not turn a small sample into a market-wide conclusion. Consumer-protection records favor clear ownership of complaints and responses.', decision: 'Can the role categorize and summarize feedback while leaving policy, remedy, and product decisions with the owner?', evidence: 'consumer-protection complaint records and bounded qualitative analysis', angle: 'turning support conversations into reviewable themes without overstating them', caseStudy: 'a month of delivery complaints where several comments describe the same failure in different words', measure: 'coded comments with source links, uncoded exceptions, and owner-confirmed themes' },
  { slug: 'philippines-ecommerce-catalog-compliance-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Ecommerce Catalog Compliance Research 2026', cluster: 'Ecommerce Operations', statistic: '8 catalog fields', statLabel: 'catalog fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/regions/consumer-welfare/', focus: 'ecommerce catalog compliance', finding: 'Catalog accuracy is a customer-protection issue as well as a merchandising task. Product claims, conditions, inclusions, and return information need approved sources and a clear owner for changes.', decision: 'Which fields can be checked against an approved source, and which edits require product or legal review?', evidence: 'DTI consumer-information and fair-trade guidance', angle: 'separating field verification from authority to change a product claim', caseStudy: 'a product page whose size, warranty, and return statements disagree with the source record', measure: 'fields checked, source mismatches, approved corrections, and blocked listings' },
  { slug: 'philippines-remittance-matching-support-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Remittance Matching Support Research 2026', cluster: 'Finance Operations', statistic: '5 matching fields', statLabel: 'matching fields', sourceName: 'Bangko Sentral ng Pilipinas', sourceUrl: 'https://www.bsp.gov.ph/', focus: 'remittance matching support', finding: 'Matching incoming records to invoices is a preparation task, not payment approval. Financial-control guidance supports keeping evidence, exceptions, and authorization separate so an unresolved match cannot silently become a posted decision.', decision: 'Which fields may be compared by support staff, and when must a mismatch return to the finance owner?', evidence: 'central-bank financial-control and recordkeeping guidance', angle: 'reconciling reference data without giving the preparer payment authority', caseStudy: 'two deposits with similar amounts but different customer references and dates', measure: 'matched records, unresolved mismatches, supporting evidence, and owner corrections' },
  { slug: 'philippines-recruiting-candidate-data-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Recruiting Candidate Data Research 2026', cluster: 'Recruitment Operations', statistic: '7 record fields', statLabel: 'record fields', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/data-privacy-act/', focus: 'recruiting candidate data handling', finding: 'Candidate records need a stated purpose, limited access, and a retention decision. Privacy guidance makes recruitment coordination different from unrestricted copying of resumes and identity documents.', decision: 'What information is necessary for the current hiring step, who may see it, and when should an outdated record be removed?', evidence: 'Data Privacy Act principles and National Privacy Commission guidance', angle: 'purpose limitation and access boundaries in candidate coordination', caseStudy: 'a shared folder containing resumes for closed roles and duplicate identity attachments', measure: 'records with a stated purpose, access exceptions, duplicates removed, and retention decisions' },
  { slug: 'philippines-executive-meeting-preparation-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Executive Meeting Preparation Research 2026', cluster: 'Executive Support', statistic: '6 briefing fields', statLabel: 'briefing fields', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/advisories/', focus: 'executive meeting preparation', finding: 'Meeting preparation creates value when the brief distinguishes confirmed facts, open questions, and private material. Privacy guidance supports minimizing personal data while keeping the executive responsible for decisions and commitments.', decision: 'What can be gathered and formatted, and which interpretation or commitment must come from the executive?', evidence: 'responsible personal-data handling applied to meeting records', angle: 'preparing a concise brief without turning background research into executive decisions', caseStudy: 'a supplier meeting with unresolved performance issues and several confidential attachments', measure: 'confirmed facts, open questions, sensitive items restricted, and post-meeting actions assigned' },
  { slug: 'philippines-document-digitization-indexing-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Document Digitization Indexing Research 2026', cluster: 'Data Operations', statistic: '9 index fields', statLabel: 'index fields', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/', focus: 'document digitization indexing', finding: 'Scanning a document is not the same as making it findable. Records work needs a consistent index, an image-quality check, and a route for uncertain names, dates, or document types.', decision: 'Which metadata can be transcribed from the page, and which uncertainty requires source-owner review?', evidence: 'official statistics and records-oriented information practices', angle: 'making scanned business records searchable without guessing at ambiguous fields', caseStudy: 'a batch of invoices with faint dates, repeated supplier names, and handwritten references', measure: 'indexed pages, low-confidence fields, duplicate images, and retrieval test results' },
  { slug: 'philippines-vendor-renewal-tracking-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Vendor Renewal Tracking Research 2026', cluster: 'Procurement Operations', statistic: '6 renewal signals', statLabel: 'renewal signals', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/', focus: 'vendor renewal tracking', finding: 'A renewal calendar can surface dates and missing documents, but it cannot replace a commercial or legal review. Procurement records are safer when notice dates, contract sources, and owner decisions remain distinct.', decision: 'Can the support role identify an approaching renewal and collect approved evidence without accepting new terms?', evidence: 'DTI business and consumer-trade guidance applied to procurement records', angle: 'date and document tracking at the boundary between administration and contract authority', caseStudy: 'a service agreement approaching renewal with a missing notice clause and an amended attachment', measure: 'renewals surfaced, source documents attached, unresolved terms, and owner decisions recorded' },
  { slug: 'philippines-service-request-dispatch-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Service Request Dispatch Research 2026', cluster: 'Property Operations', statistic: '7 dispatch states', statLabel: 'dispatch states', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/statistics/housing', focus: 'service request dispatch', finding: 'Dispatch coordination works when a request has a location, urgency description, owner, and status history. Property data can inform the record, but it does not give a coordinator authority to approve unsafe work or alter a tenant obligation.', decision: 'Which requests can be classified and routed, and which need an owner, contractor, or safety decision?', evidence: 'Philippine housing and property data used as context for request records', angle: 'routing maintenance requests while preserving safety and property-owner decisions', caseStudy: 'a water-leak report that changes from a standard repair to a possible building emergency', measure: 'requests with complete location data, status changes, overdue items, and escalations' }
];
