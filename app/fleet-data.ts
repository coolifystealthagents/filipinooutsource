...
const dailyResearchBatchAugust13: readonly August13ResearchConfig[] = [
  { slug: 'philippines-service-request-priority-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Service Request Priority Research 2026', cluster: 'Customer Support', statistic: '5 priority signals', statLabel: 'priority signals', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/archives/consumer-protection/', focus: 'service request priority classification', finding: 'A request queue becomes more reviewable when urgency, customer impact, promised response, source record, and uncertainty are separated rather than compressed into one label.', decision: 'Which observable facts support a priority label, and who may override it when a policy or safety consequence is involved?', evidence: 'DTI consumer-protection guidance and documented complaint-handling principles', angle: 'classifying incoming service requests using evidence instead of intuition', caseStudy: 'a delayed order reported alongside a separate message claiming a safety concern', measure: 'requests with cited priority signals, reclassifications, aging items, and owner overrides' },
  { slug: 'philippines-knowledge-transfer-records-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Knowledge Transfer Records Research 2026', cluster: 'Remote Operations', statistic: '6 transfer fields', statLabel: 'transfer fields', sourceName: 'Department of Information and Communications Technology', sourceUrl: 'https://dict.gov.ph/', focus: 'knowledge transfer records', finding: 'Knowledge transfer is measurable when a task example, source reference, exception, and receiving owner are recorded together instead of relying on a meeting recap alone.', decision: 'What evidence proves that a handoff was understood, and which unresolved judgment must remain with the receiving owner?', evidence: 'DICT digital-work and information-management guidance', angle: 'preserving operational knowledge across distributed support teams', caseStudy: 'a departing coordinator leaves a short note that omits the exception cases the next reviewer encounters', measure: 'examples with source links, unanswered questions, repeat clarifications, and receiving-owner confirmations' },
  { slug: 'philippines-customer-account-change-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Customer Account Change Research 2026', cluster: 'Data Operations', statistic: '7 change controls', statLabel: 'change controls', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/data-privacy-act/', focus: 'customer account change records', finding: 'Account-change preparation needs an auditable request, identity context, affected field, and approval state so that convenience does not erase accountability for personal data.', decision: 'Which change may be prepared from the approved request, and which identity or entitlement question requires an owner decision?', evidence: 'Data Privacy Act principles on purpose, accuracy, security, and controlled personal-data handling', angle: 'recording customer account changes without granting unverified authority', caseStudy: 'a request to change a billing contact arrives from an address not listed in the account record', measure: 'requests with evidence links, verification pauses, changed fields, and owner approvals' },
  { slug: 'philippines-order-exception-review-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Order Exception Review Research 2026', cluster: 'Ecommerce Operations', statistic: '6 exception fields', statLabel: 'exception fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/regions/consumer-welfare/', focus: 'order exception review', finding: 'Order exceptions become actionable when the order identity, customer request, status evidence, policy reference, and unresolved conflict remain together.', decision: 'Which order facts can be verified, and when must an owner decide whether a policy exception or remedy is permitted?', evidence: 'DTI consumer-information and fair-trade guidance', angle: 'preparing order exception cases without turning record work into an entitlement decision', caseStudy: 'an order marked delivered has a customer report and carrier evidence that do not agree', measure: 'cases with linked evidence, policy conflicts, owner decisions, and repeat contacts' },
  { slug: 'philippines-invoice-exception-analysis-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Invoice Exception Analysis Research 2026', cluster: 'Finance Operations', statistic: '6 exception categories', statLabel: 'exception categories', sourceName: 'Bangko Sentral ng Pilipinas', sourceUrl: 'https://www.bsp.gov.ph/', focus: 'invoice exception analysis', finding: 'Invoice review is more useful when amount, supplier, purchase reference, receipt evidence, and mismatch type are visible before a finance owner decides what to do.', decision: 'Which mismatch is a data correction, and which one changes an approval or payment decision?', evidence: 'BSP financial-system and risk-control principles applied to invoice records', angle: 'separating invoice evidence preparation from payment authority', caseStudy: 'an invoice matches the supplier but exceeds the approved purchase reference by an unexplained amount', measure: 'invoices with linked evidence, mismatch categories, duplicate candidates, and owner resolutions' },
  { slug: 'philippines-candidate-document-check-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Candidate Document Check Research 2026', cluster: 'Recruitment Operations', statistic: '5 document checks', statLabel: 'document checks', sourceName: 'Department of Labor and Employment', sourceUrl: 'https://www.dole.gov.ph/', focus: 'candidate document checks', finding: 'Recruitment administration should distinguish whether a document is present, legible, current, and relevant to the approved hiring stage without turning a checklist into a hiring decision.', decision: 'Which document facts may be recorded, what sensitive detail is unnecessary, and who decides whether a candidate can proceed?', evidence: 'DOLE employment guidance and privacy-aware recruitment administration', angle: 'checking recruitment documents while limiting collection and preserving hiring judgment', caseStudy: 'a candidate submits an unreadable document that contains more personal detail than the hiring stage needs', measure: 'documents matched to purpose, missing items, unnecessary fields, and owner decisions' },
  { slug: 'philippines-executive-brief-source-check-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Executive Brief Source Check Research 2026', cluster: 'Executive Support', statistic: '6 source checks', statLabel: 'source checks', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/statistics', focus: 'executive brief source checking', finding: 'An executive brief earns trust when each material number has a source, period, definition, and stated limitation rather than an impressive but context-free headline.', decision: 'Which source differences can be explained in the brief, and which interpretation must be approved by the executive owner?', evidence: 'PSA statistical release and definition practices', angle: 'checking management brief sources without presenting analysis as an approved decision', caseStudy: 'two reports use the same label for different periods and produce apparently conflicting totals', measure: 'claims with source dates, definition notes, unresolved conflicts, and owner-approved interpretations' },
  { slug: 'philippines-contract-index-fields-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Contract Index Fields Research 2026', cluster: 'Procurement Operations', statistic: '8 index fields', statLabel: 'index fields', sourceName: 'Official Gazette of the Republic of the Philippines', sourceUrl: 'https://www.officialgazette.gov.ph/', focus: 'contract index fields', finding: 'A contract index helps retrieval when parties, effective period, governing document, renewal status, and owner are captured without implying that an indexer can interpret legal meaning.', decision: 'Which facts can be transcribed from the approved contract, and which clause or conflict requires legal or commercial review?', evidence: 'Official Gazette legal-publication context and document-control principles', angle: 'making contract records searchable while preserving interpretation authority', caseStudy: 'a renewal notice appears in a folder but its relationship to the signed agreement is unclear', measure: 'records with source locations, date fields, duplicate candidates, and owner escalations' },
  { slug: 'philippines-supplier-document-expiry-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Supplier Document Expiry Research 2026', cluster: 'Procurement Operations', statistic: '7 validity fields', statLabel: 'validity fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/', focus: 'supplier document expiry tracking', finding: 'Supplier evidence is easier to review when document identity, validity period, issuing source, and unresolved gaps are visible without turning tracking into supplier approval.', decision: 'Which dates can be checked from the document, and which expired or conflicting item needs procurement-owner review?', evidence: 'DTI business and trade guidance applied to supplier records', angle: 'tracking supplier document validity without accepting a compliance or commercial conclusion', caseStudy: 'a supplier file contains a current registration document and an expired supporting certificate', measure: 'documents with validity dates, source links, expired items, and owner resolutions' },
  { slug: 'philippines-property-maintenance-evidence-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Property Maintenance Evidence Research 2026', cluster: 'Property Operations', statistic: '7 maintenance fields', statLabel: 'maintenance fields', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/statistics/population-and-housing', focus: 'property maintenance evidence', finding: 'Maintenance coordination improves when location, reported condition, photographs, vendor status, and completion evidence are kept in one traceable record.', decision: 'Which facts can be routed to a vendor, and which condition requires a property, tenant-impact, or safety decision?', evidence: 'PSA housing context used with bounded property-record analysis', angle: 'organizing maintenance evidence without making a safety or tenancy determination', caseStudy: 'a repair image shows a wider water problem than the original tenant request describes', measure: 'work orders with location proof, status history, overdue items, and safety escalations' }
];
