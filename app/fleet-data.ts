...
const dailyResearchBatchAugust13: readonly August13ResearchConfig[] = [
  { slug: 'philippines-call-disposition-records-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Call Disposition Records Research 2026', cluster: 'Customer Support', statistic: '6 disposition fields', statLabel: 'disposition fields', sourceName: 'Department of Information and Communications Technology', sourceUrl: 'https://dict.gov.ph/', focus: 'call disposition records', finding: 'A call log is useful when its outcome, source, follow-up owner, and uncertainty are recorded consistently. Digital information governance supports treating disposition data as a reviewable business record rather than a memory aid.', decision: 'Which call facts may be recorded, which follow-up requires approval, and how should an uncertain outcome be marked?', evidence: 'digital information governance and records-management principles', angle: 'turning customer call outcomes into traceable records without inventing commitments', caseStudy: 'a call where a customer asks for a policy exception that the coordinator cannot approve', measure: 'records with source references, incomplete dispositions, owner corrections, and overdue follow-ups' },
  { slug: 'philippines-shift-handoff-documentation-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Shift Handoff Documentation Research 2026', cluster: 'Remote Operations', statistic: '5 handoff fields', statLabel: 'handoff fields', sourceName: 'Department of Labor and Employment', sourceUrl: 'https://www.dole.gov.ph/', focus: 'shift handoff documentation', finding: 'A handoff record should distinguish completed work, pending evidence, and an owner decision. Workplace guidance and operational continuity principles make the record more dependable than an informal status message.', decision: 'What must be transferred at shift change, who accepts the open item, and which issue needs manager review?', evidence: 'Philippine workplace guidance and continuity-oriented recordkeeping', angle: 'preserving accountability when support work crosses schedules', caseStudy: 'an unresolved customer request handed from a Philippines-based coordinator to a client-side reviewer', measure: 'open items with named owners, repeated explanations, late handoffs, and missing source details' },
  { slug: 'philippines-complaint-evidence-indexing-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Complaint Evidence Indexing Research 2026', cluster: 'Customer Support', statistic: '7 evidence fields', statLabel: 'evidence fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/archives/consumer-protection/', focus: 'complaint evidence indexing', finding: 'Complaint review improves when each assertion points back to the customer record, transaction detail, or response history that supports it. Consumer-protection principles support separating evidence assembly from remedy decisions.', decision: 'Which evidence can be indexed, what remains unresolved, and who decides whether a remedy is appropriate?', evidence: 'consumer-protection complaint handling and evidence traceability', angle: 'organizing complaint records without promising a customer outcome', caseStudy: 'a delivery complaint with screenshots, a partial order record, and conflicting status updates', measure: 'claims linked to evidence, unresolved facts, duplicate cases, and owner-approved dispositions' },
  { slug: 'philippines-product-return-records-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Product Return Records Research 2026', cluster: 'Ecommerce Operations', statistic: '6 return fields', statLabel: 'return fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/regions/consumer-welfare/', focus: 'product return records', finding: 'Return records need a clear link between the order, customer request, received evidence, and policy reference. Consumer-information guidance supports accurate preparation while leaving eligibility and remedy decisions with the owner.', decision: 'Which return facts may be verified, and when must a policy or product owner decide the case?', evidence: 'DTI consumer-information and fair-trade guidance', angle: 'preparing return cases without turning record work into an entitlement decision', caseStudy: 'a returned item whose condition and purchase reference do not fully agree', measure: 'cases with complete evidence, policy conflicts, owner decisions, and repeated customer contacts' },
  { slug: 'philippines-expense-receipt-reconciliation-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Expense Receipt Reconciliation Research 2026', cluster: 'Finance Operations', statistic: '6 receipt fields', statLabel: 'receipt fields', sourceName: 'Bangko Sentral ng Pilipinas', sourceUrl: 'https://www.bsp.gov.ph/', focus: 'expense receipt reconciliation', finding: 'Receipt reconciliation is strongest when the source image, transaction context, and unresolved discrepancy stay together. Financial-control principles support preparation and review without granting reimbursement authority to the preparer.', decision: 'Which receipt details can be checked, and when must a finance owner decide whether an expense is allowable?', evidence: 'central-bank recordkeeping and financial-control guidance', angle: 'organizing expense evidence while separating verification from approval', caseStudy: 'a receipt with a readable merchant and date but an unclear business purpose', measure: 'receipts linked to transactions, missing fields, duplicate submissions, and owner corrections' },
  { slug: 'philippines-candidate-interview-evidence-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Candidate Interview Evidence Research 2026', cluster: 'Recruitment Operations', statistic: '6 interview fields', statLabel: 'interview fields', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/data-privacy-act/', focus: 'candidate interview evidence', finding: 'Interview coordination records should identify the stage, consent-relevant context, participants, and next owner without collecting more personal information than the hiring step needs.', decision: 'What may be scheduled and recorded, who may access the notes, and which employment judgment stays with the hiring owner?', evidence: 'Data Privacy Act principles and National Privacy Commission guidance', angle: 'keeping recruitment coordination factual while protecting candidate information', caseStudy: 'an interview note containing a hiring opinion alongside scheduling details and unrelated personal data', measure: 'records limited to purpose, access exceptions, missing consent context, and owner decisions' },
  { slug: 'philippines-board-packet-research-support-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Board Packet Research Support 2026', cluster: 'Executive Support', statistic: '7 packet checks', statLabel: 'packet checks', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/advisories/', focus: 'board packet research support', finding: 'A board packet is easier to review when each figure, attachment, and open question has a source and an owner. Privacy guidance supports minimizing sensitive distribution while leaving interpretation and governance decisions with authorized leaders.', decision: 'Which source material may be assembled, who approves distribution, and which conclusions must remain with the board or executive?', evidence: 'responsible personal-data handling applied to executive records', angle: 'assembling decision material without presenting research notes as approved conclusions', caseStudy: 'a packet with draft metrics, confidential attachments, and an unresolved compliance question', measure: 'source-linked claims, restricted attachments, unresolved questions, and owner-approved changes' },
  { slug: 'philippines-archive-retention-indexing-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Archive Retention Indexing Research 2026', cluster: 'Data Operations', statistic: '8 retention fields', statLabel: 'retention fields', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/', focus: 'archive retention indexing', finding: 'An archive index should make the record type, date range, owner, and retention status visible without pretending that an administrator can decide legal disposal rules.', decision: 'Which metadata can be captured from the approved schedule, and which retention conflict must go to the records owner?', evidence: 'official statistics and records-oriented information practices', angle: 'making business archives searchable while preserving retention authority', caseStudy: 'a shared archive containing duplicate contracts, expired drafts, and records with unclear owners', measure: 'records with retention labels, duplicate candidates, unresolved ownership, and retrieval test results' },
  { slug: 'philippines-supplier-certificate-tracking-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Supplier Certificate Tracking Research 2026', cluster: 'Procurement Operations', statistic: '7 certificate fields', statLabel: 'certificate fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/', focus: 'supplier certificate tracking', finding: 'Supplier certificates are useful only when document identity, validity period, issuing source, and unresolved gaps are visible. Trade guidance supports evidence collection without turning tracking into supplier approval.', decision: 'Which certificate details can be checked, and which expired or conflicting document needs procurement-owner review?', evidence: 'DTI business and trade guidance applied to supplier records', angle: 'tracking supplier evidence without accepting a compliance or commercial conclusion', caseStudy: 'a supplier file with a current registration document and an expired supporting certificate', measure: 'documents with validity dates, source links, expired items, and owner resolutions' },
  { slug: 'philippines-facility-vendor-work-orders-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Facility Vendor Work Orders Research 2026', cluster: 'Property Operations', statistic: '6 work-order fields', statLabel: 'work-order fields', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/statistics/housing', focus: 'facility vendor work orders', finding: 'A work-order record should connect location, reported condition, assigned vendor, status changes, and completion evidence. Property data provides context, but safety and tenant-impact decisions remain with the authorized owner.', decision: 'Which request details can be routed, and which condition requires a property, contractor, or safety decision?', evidence: 'Philippine housing and property data used as context for work-order records', angle: 'maintaining vendor work orders while preserving property-owner and safety authority', caseStudy: 'a repair request whose photographs reveal a possible hazard beyond the original description', measure: 'work orders with complete locations, status history, overdue items, and safety escalations' }
];
