...
const dailyResearchBatchAugust13: readonly August13ResearchConfig[] = [
  { slug: 'philippines-escalation-evidence-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Escalation Evidence Research 2026', cluster: 'Customer Support', statistic: '5 escalation fields', statLabel: 'escalation fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/archives/consumer-protection/', focus: 'customer escalation evidence', finding: 'Escalation records are more useful when the original request, promised response, customer impact, prior action, and unresolved question remain visible together.', decision: 'Which facts can be documented from the record, and which remedy or safety judgment must remain with the service owner?', evidence: 'DTI consumer-protection guidance and documented complaint-handling principles', angle: 'making customer escalations reviewable without deciding the remedy', caseStudy: 'a repeat complaint includes a previous promise but the supporting order history is incomplete', measure: 'cases with source evidence, repeat contacts, missing fields, owner decisions, and aging' },
  { slug: 'philippines-support-knowledge-gap-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Support Knowledge Gap Research 2026', cluster: 'Remote Operations', statistic: '6 gap indicators', statLabel: 'gap indicators', sourceName: 'Department of Information and Communications Technology', sourceUrl: 'https://dict.gov.ph/', focus: 'support knowledge gaps', finding: 'A knowledge gap is easier to correct when the missing example, source reference, exception pattern, affected queue, and accountable owner are recorded rather than inferred from repeated questions.', decision: 'What can be clarified from existing evidence, and which policy or process change requires the receiving owner?', evidence: 'DICT digital-work and information-management guidance', angle: 'measuring missing support knowledge across distributed teams', caseStudy: 'the same customer question is answered three ways because the exception is absent from the shared reference', measure: 'repeat questions, missing examples, conflicting answers, unresolved exceptions, and owner updates' },
  { slug: 'philippines-digital-file-retention-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Digital File Retention Research 2026', cluster: 'Data Operations', statistic: '7 retention fields', statLabel: 'retention fields', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/data-privacy-act/', focus: 'digital file retention records', finding: 'Retention review needs a file purpose, data category, source, review date, access owner, disposal status, and exception note before a record can be responsibly managed.', decision: 'Which file facts can be inventoried, and which retention or deletion decision requires the data owner?', evidence: 'Data Privacy Act principles on purpose, accuracy, security, and controlled personal-data handling', angle: 'inventorying digital records without making an unauthorized deletion decision', caseStudy: 'a shared folder contains duplicate customer files but no documented business purpose or review owner', measure: 'files with purpose tags, access owners, review dates, duplicate candidates, and escalations' },
  { slug: 'philippines-delivery-promise-evidence-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Delivery Promise Evidence Research 2026', cluster: 'Ecommerce Operations', statistic: '6 promise fields', statLabel: 'promise fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/regions/consumer-welfare/', focus: 'delivery promise evidence', finding: 'Delivery reviews are clearer when the promised window, order event, carrier status, customer communication, location context, and unresolved variance are kept together.', decision: 'Which delivery facts can be reconciled, and when must an owner decide whether a revised promise or remedy is allowed?', evidence: 'DTI consumer-information and fair-trade guidance', angle: 'examining delivery promises without converting records into a remedy decision', caseStudy: 'a checkout promise and carrier scan use different time windows for the same order', measure: 'orders with promise sources, event timestamps, variance categories, repeat contacts, and owner outcomes' },
  { slug: 'philippines-purchase-order-match-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Purchase Order Match Research 2026', cluster: 'Finance Operations', statistic: '6 match fields', statLabel: 'match fields', sourceName: 'Bangko Sentral ng Pilipinas', sourceUrl: 'https://www.bsp.gov.ph/', focus: 'purchase order matching', finding: 'A purchase-order match is inspectable when supplier identity, ordered quantity, received quantity, invoice reference, tax treatment, and variance are shown before approval.', decision: 'Which mismatch is an input correction, and which variance changes a payment or authorization decision?', evidence: 'BSP financial-system and risk-control principles applied to transaction records', angle: 'preparing three-way match evidence without granting payment authority', caseStudy: 'the received quantity is lower than the purchase order while the invoice reflects the original quantity', measure: 'records with linked documents, match outcomes, variance categories, duplicate candidates, and owner resolutions' },
  { slug: 'philippines-training-attendance-records-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Training Attendance Records Research 2026', cluster: 'Recruitment Operations', statistic: '5 attendance fields', statLabel: 'attendance fields', sourceName: 'Department of Labor and Employment', sourceUrl: 'https://www.dole.gov.ph/', focus: 'training attendance records', finding: 'Training records are more reliable when the participant, session, date, completion evidence, and unresolved attendance issue are separated from the manager’s performance judgment.', decision: 'Which attendance facts can be recorded, what personal detail is unnecessary, and who decides whether a requirement is satisfied?', evidence: 'DOLE employment guidance and privacy-aware people administration', angle: 'documenting training participation without making an employment decision', caseStudy: 'a participant is listed as present but the completion evidence is missing for one required session', measure: 'sessions with source evidence, missing confirmations, duplicate entries, unresolved attendance, and owner decisions' },
  { slug: 'philippines-meeting-decision-records-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Meeting Decision Records Research 2026', cluster: 'Executive Support', statistic: '6 decision fields', statLabel: 'decision fields', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/statistics', focus: 'meeting decision records', finding: 'A decision record is easier to trust when the question, evidence period, agreed action, accountable owner, and unresolved assumption are distinguished from the meeting narrative.', decision: 'Which facts can be transcribed from the approved discussion, and which interpretation or commitment requires executive confirmation?', evidence: 'PSA statistical release and definition practices applied to management records', angle: 'capturing decisions with evidence boundaries instead of producing impressionistic minutes', caseStudy: 'a meeting note says performance improved without naming the comparison period or underlying measure', measure: 'decisions with source periods, defined measures, open assumptions, owner confirmations, and later corrections' },
  { slug: 'philippines-renewal-notice-tracking-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Renewal Notice Tracking Research 2026', cluster: 'Procurement Operations', statistic: '8 notice fields', statLabel: 'notice fields', sourceName: 'Official Gazette of the Republic of the Philippines', sourceUrl: 'https://www.officialgazette.gov.ph/', focus: 'renewal notice tracking', finding: 'Renewal tracking is safer when notice date, agreement reference, effective period, recipient, source location, and uncertainty are visible without implying that a tracker can interpret the agreement.', decision: 'Which notice facts can be transcribed, and which deadline, clause, or commercial consequence requires owner or legal review?', evidence: 'Official Gazette legal-publication context and document-control principles', angle: 'tracking contractual notices while preserving interpretation authority', caseStudy: 'an email mentions renewal but the signed agreement and notice period are not linked in the record', measure: 'notices with source locations, agreement links, date fields, unresolved conflicts, and owner escalations' },
  { slug: 'philippines-supplier-contact-verification-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Supplier Contact Verification Research 2026', cluster: 'Procurement Operations', statistic: '7 contact fields', statLabel: 'contact fields', sourceName: 'Department of Trade and Industry', sourceUrl: 'https://www.dti.gov.ph/', focus: 'supplier contact verification', finding: 'Supplier contact records are more dependable when the organization, named contact, source date, channel, relationship, and unresolved discrepancy are separated from a procurement approval.', decision: 'Which contact facts can be checked against an approved source, and which identity or authority concern needs procurement-owner review?', evidence: 'DTI business and trade guidance applied to supplier records', angle: 'verifying supplier contacts without accepting a commercial or compliance conclusion', caseStudy: 'a new bank-contact email differs from the approved supplier record but no supporting notice is attached', measure: 'contacts with source dates, verification channels, discrepancies, duplicate candidates, and owner resolutions' },
  { slug: 'philippines-tenant-move-in-coordination-research-2026', sourceDate: '2026-08-13', datePublished: '2026-08-13', title: 'Philippines Tenant Move-In Coordination Research 2026', cluster: 'Property Operations', statistic: '7 move-in fields', statLabel: 'move-in fields', sourceName: 'Philippine Statistics Authority', sourceUrl: 'https://psa.gov.ph/statistics/population-and-housing', focus: 'tenant move-in coordination records', finding: 'Move-in coordination is easier to inspect when unit identity, scheduled date, access instructions, condition evidence, responsible vendor, completion status, and unresolved issue are kept together.', decision: 'Which logistics facts can be coordinated, and which property condition, tenant-impact, or safety question requires an owner decision?', evidence: 'PSA housing context used with bounded property-record analysis', angle: 'organizing move-in evidence without making a tenancy or safety determination', caseStudy: 'a move-in date is confirmed but the access instruction and initial condition record conflict', measure: 'move-ins with location proof, date confirmations, missing instructions, vendor status, and escalations' }
];
