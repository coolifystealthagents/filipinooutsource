...
import { september9ResearchPosts } from './research-september9';
import { september10ResearchPosts } from './research-september10';
import { september14ResearchPosts } from './research-september14';
import { september18ResearchPosts } from './research-september18';
import { september22ResearchPosts } from './research-september22';
...
const dailyResearchBatch: readonly BatchResearchConfig[] = [
  ...
  { slug: 'philippines-executive-assistance-workflow-research-2026', datePublished: '2026-08-07', dateModified: '2026-09-05', title: 'Philippines Executive Assistance Workflow Research 2026', cluster: 'Executive Support', statistic: '4 access tiers', statLabel: 'access tiers', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/advisories/', focus: 'executive assistance workflow design', serviceHandoff: { heading: 'Turn the workflow into a role brief', copy: 'Use the executive assistance guide to set calendar access, follow-up limits, and the executive or chief of staff who approves schedule changes and outgoing commitments.', label: 'Review executive assistance', href: '/services/executive-assistance' } },
...
const dailyResearchBatchAugust09: readonly BatchResearchConfig[] = [
  ...
  { slug: 'philippines-calendar-coordination-research-2026', datePublished: '2026-08-09', dateModified: '2026-09-08', title: 'Philippines Calendar Coordination Research 2026', cluster: 'Executive Support', statistic: '3 review windows', statLabel: 'review windows', sourceName: 'National Privacy Commission', sourceUrl: 'https://privacy.gov.ph/advisories/', focus: 'calendar coordination', serviceHandoff: { heading: 'Set the calendar handoff', copy: 'Use the executive assistance guide to set the calendar view, the follow-up limit, and the person who approves a schedule change or an outside commitment. The support role can prepare the handoff, but the executive or chief of staff keeps the final decision.', label: 'Review executive assistance', href: '/services/executive-assistance' } },
