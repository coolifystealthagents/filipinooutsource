    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Warm recruiting field guide</p>
          <h1>Filipino Outsource: a talent field notes for clearer staffing decisions.</h1>
          <p className="lead">A redesigned Filipino outsource staffing guide for businesses considering Filipino offshore talent for support and operations. The page now uses a distinct organic editorial layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>passport stamps and warm paper blocks</figcaption></figure>
      </div>
    </section>
