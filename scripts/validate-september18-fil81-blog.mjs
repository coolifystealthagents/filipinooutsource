...
const shared = fs.readFileSync('app/blog-september18.ts','utf8');
...
const sharedWords = shared.match(/function buildSeptember18Detail[\s\S]*?export const september18BlogPosts/)?.[0].split(/\s+/).length ?? 0;
