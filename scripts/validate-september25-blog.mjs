...
const batchPath='app/blog-september25.ts', sharedPath='app/blog-september25-detail.ts', manifestPath='.paperclip/daily-content/2026-09-25/blog.json';
...
if(!batch.includes('buildSeptember25Detail'))throw new Error('Topic-specific detail builder missing');
...
console.log(`SEPTEMBER25_BLOG_SOURCE_PASS count=${slugs.length} manifest=${manifestPath}`);
